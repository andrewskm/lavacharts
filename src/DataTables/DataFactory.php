...
use Andrewskm\Lavacharts\Exceptions\InvalidJson;
...
class DataFactory
{
    ...
    {
        $datatable = '\Andrewskm\Lavacharts\DataTablePlus\DataTablePlus';

        if (class_exists($datatable) === false) {
            $datatable = '\Andrewskm\Lavacharts\DataTables\DataTable';
        }
