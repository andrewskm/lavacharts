...
use Andrewskm\Lavacharts\Volcano;
 ...
 * @property \Andrewskm\Lavacharts\Volcano volcano
 */
class VolcanoTest extends ProvidersTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->mockGoodLabel = \Mockery::mock('\Andrewskm\Lavacharts\Values\Label', ['TestRenderable'])->makePartial();

        $this->mockBadLabel = \Mockery::mock('\Andrewskm\Lavacharts\Values\Label', ['Pumpkins'])->makePartial();
        ...
        $this->mockDashboard = \Mockery::mock('\Andrewskm\Lavacharts\Dashboards\Dashboard', [
            $this->mockGoodLabel,
            $this->getMockDataTable()
    ...
    {
        $chart = \Mockery::mock('\Andrewskm\Lavacharts\Dashboards\Dashboard', [
            $this->mockGoodLabel,
            $this->getMockDataTable()
        ])->shouldReceive('getLabel')
          ->andReturn('TestRenderable')
    ...
    public function testGetChart()
    {
        ...
        $this->assertInstanceOf('\Andrewskm\Lavacharts\Charts\LineChart', $this->volcano->get('LineChart', $this->mockGoodLabel));
    }
     ...
     * @expectedException \Andrewskm\Lavacharts\Exceptions\ChartNotFound
     */
    ...
    public function testGetDashboard()
    {
        ...
        $this->assertInstanceOf('\Andrewskm\Lavacharts\Dashboards\Dashboard', $dash);
    }
     ...
     * @expectedException \Andrewskm\Lavacharts\Exceptions\DashboardNotFound
     */
    ...
    public function testGetAll()
    {
        ...
        foreach ($this->volcano->getAll() as $renderable) {
            $this->assertInstanceOf('\Andrewskm\Lavacharts\Support\Contracts\RenderableInterface', $renderable);
        }
    }
}
