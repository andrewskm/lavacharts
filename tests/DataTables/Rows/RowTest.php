...
{
    /**
     * @covers \Andrewskm\Lavacharts\DataTables\Rows\Row::__construct
     */
    ...
    public function testConstructorWithCarbon()
    {
        ...
        $this->assertInstanceOf('\Andrewskm\Lavacharts\DataTables\Cells\DateCell', $values[0]);
        $this->assertEquals(1, $values[1]->getValue());
        $this->assertEquals(2.0, $values[2]->getValue());
    }
     ...
     * @covers \Andrewskm\Lavacharts\DataTables\Rows\Row::getCell
     */
    public function testGetColumnValue()
    {
        ...
        $this->assertInstanceOf('\Andrewskm\Lavacharts\DataTables\Cells\DateCell', $row->getCell(0));
