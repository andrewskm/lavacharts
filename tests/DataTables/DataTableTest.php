...
namespace Andrewskm\Lavacharts\Tests\DataTables;
...
class DataTableTest extends ProvidersTestCase
{
     ...
     * @expectedException \Andrewskm\Lavacharts\Exceptions\InvalidTimeZone
     */
     ...
     * @dataProvider nonStringProvider
     * @expectedException \Andrewskm\Lavacharts\Exceptions\InvalidDateTimeFormat
     */
     ...
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::addBooleanColumn
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::addStringColumn
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::addNumberColumn
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::addDateColumn
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::addDateTimeColumn
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::addTimeOfDayColumn
     */
    ...
    /**
     * @expectedException \Andrewskm\Lavacharts\Exceptions\InvalidColumnDefinition
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::addColumns
     */
    ...
    /**
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::addRoleColumn
     */
     ...
     * @expectedException \Andrewskm\Lavacharts\Exceptions\InvalidColumnIndex
     */
     ...
     * @depends testAddColumnViaNamedAlias
     * @expectedException \Andrewskm\Lavacharts\Exceptions\InvalidColumnIndex
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::dropColumn
     */
     ...
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::addColumn
     */
    ...
    /**
     * @depends testAddColumnViaNamedAlias
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::addRow
     */
    ...
    public function testAddRowWithDate()
    {
        ...
        $this->assertEquals('date', $column->getType());
        $this->assertInstanceOf('\Andrewskm\Lavacharts\Datatables\Cells\DateCell', $cell);
    ...
    /**
     * @depends testAddColumnViaNamedAlias
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::addRows
     */
    ...
    /**
     * @depends testAddColumnViaNamedAlias
     * @expectedException \Andrewskm\Lavacharts\Exceptions\InvalidCellCount
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::addRow
     */
     ...
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::getRows
     */
    ...
    /**
     * @depends testGetRows
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::getRowCount
     */
    ...
    /**
     * @depends testAddColumnViaNamedAlias
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::formatColumn
     */
     ...
     * @depends testAddColumnViaNamedAlias
     * @depends testFormatColumn
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::formatColumns
     */
     ...
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::getFormattedColumns
     */
     ...
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::hasFormattedColumns
     */
    ...
    /**
     * @depends testAddColumnWithTypeAndLabel
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::getColumn
     */
    ...
    /**
     * @depends testAddColumnWithTypeAndLabel
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::getColumnLabel
     */
    ...
    /**
     * @depends testAddColumnWithTypeAndLabel
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::getColumnLabels
     */
    ...
    /**
     * @depends testAddColumnWithTypeAndLabel
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::getColumnType
     */
    ...
    /**
     * @depends testAddColumnViaNamedAlias
     * @covers \Andrewskm\Lavacharts\DataTables\DataTable::getColumnsByType
     */
