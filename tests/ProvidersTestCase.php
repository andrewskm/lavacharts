...
define('DATATABLE_NS', "\\Andrewskm\\Lavacharts\\DataTables\\");
...
abstract class ProvidersTestCase extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return \Mockery::mock('\Andrewskm\Lavacharts\Values\Label', [$label])->makePartial();
    }
    ...
    {
        return \Mockery::mock('\Andrewskm\Lavacharts\Values\ElementId', [$label])->makePartial();
    }
    ...
    {
        return \Mockery::mock('Andrewskm\Lavacharts\DataTables\DataTable')->makePartial();
    }
